					...
					<template>
						...
						>
							<view class="content" @click="handleClick" :data-col_index="colIndex" :data-item_index="index">
								...
								<!-- 这个节点真实项目中可删除 -->
								<view v-if="(colIndex === 0 && index === 0) || (colIndex === 1 && index === 1)" style="margin-top: 8px; border: red solid 1px; padding: 8px">
									<view style="font-size: 12px; color: red; margin-bottom: 4px">次节点为演示 update 函数动态更新数据的能力， 真是项目删除即可</view>
									<view>
										<button
											size="mini"
